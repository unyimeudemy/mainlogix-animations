...
import video from "./videos/child-swings.mp4"
...
const Camera_view = ({animateCamera}) => {
    ...
    return (
        <Container>
                ...
                {displayDarkScreen && <DarkScreen
                    src={loading_screen}
                    variants={{
                        initial: { scale: 0, x: 500, y: -10, marginTop:0, marginBottom:0},
                ...
                {showHand && <Hand
                 ...
                 variants = {{
                    initial: {x:380, y:0},
                    handFirstMove: {x:550, y:0, scale:[1, 1, 0.8, 1]},
                    handSecondMove: {x:550, y:50, scale:[1, 1, 0.8, 1]}
                 }}
                 initial="initial"
                 animate={animateHand}
                 transition={{
