...
import modern_thermostate from "./videos/modern-thermostat.mp4"
...
const Thermostat = ({handleAnimate_2}) => {
    ...
    return (
        <Container>
                ...
                {showHand && <Hand
                 ...
                 variants = {{
                    initial: {x:380, y:-40},
                    handFirstMove: {x:500, y:-40, scale:[1, 1, 0.8, 1]},
                 }}
                 initial="initial"
                 animate={animateHand}
                 transition={{
