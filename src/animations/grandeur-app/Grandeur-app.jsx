...
import child_swing_video from "./videos/child-swings.mp4"
...
const Grandeur_app = ({handleAnimate_1}) => {
        ...
        setTimeout(async () => {
            ...
            setTimeout(async() => {
                ...
                setTimeout(async() => {
                    ...
                    //     setShowPhone(true)
                    //     setShowHand(true)
                    //     await animateHand.start("handThirdMove")
    ...
    return (
        <Container>
                ...
                {showHand && <Hand
                 ...
                 variants = {{
                    initial: {x:380, y:0},
                    handFirstMove: {x:455, y:0, scale:[1, 1, 0.8, 1]},
                    handSecondMove: {x:550, y:20, scale:[1, 1, 0.8, 1]},
                    // handThirdMove: {x:700, y:50, scale:[1, 1, 0.8, 1]},
                 }}
                 initial="initial"
                 animate={animateHand}
                 transition={{
                ...
                >
                    <source src={selective_light_video} />
                </Video>}
        </Container>
    )
}

export default Grandeur_app;